<template>
  ...
  <div class="max-w-screen-lg mx-auto p-5 ">
    <div class="grid grid-cols-1 md:grid-cols-12 border rounded-r-lg">
      <div class="bg-cyan-500 md:col-span-4 p-10 text-white rounded-l-lg">
        ...
        >
          Perro <span class="text-indigo-200">Feliz</span>
        </h3>
        <p class="mt-4 leading-7 text-gray-200 font-bold">
          Hola, déjanos tus consultas que nuestro equipo se pondrá en contacto con Ud. respondiendo sus dudas en la brevedad. <br />
          ¡Muchas gracias por elegir Veterinaria Perro Feliz!!
        </p>

        <div class="flex items-center mt-5">
          <svg
            class="h-6 mr-2 text-zinc-50 "
            fill="currentColor"
            version="1.1"
          ...
          <span class="text-sm"
            >Nuemero #14, Calle xxx, Provincia xxx, Pais xxx.</span
          >
        </div>
        <div class="flex items-center mt-5 ">
          <svg
		...
		c0.067,0.04,6.778,4.003,8.521,7.296C52.202,48.062,51.994,49.447,51.078,50.363z"
          ...
          <span class="text-sm">+54 xxx xx xx xx</span>
        </div>
        <div class="flex items-center mt-5">
          <svg
            class="h-6 mr-2 text-zinc-50	"
      ...
      <form class="md:col-span-8 p-10 bg-cyan-50">
        ...
        <div class="flex flex-wrap -mx-3 mb-6">
          ...
          <div class="flex justify-end w-full px-5 py-5">
            <button
              class="bg-cyan-500 text-white text-sm font-bold border-0 py-2 px-6 focus:outline-none hover:bg-slate-500 shadow rounded text-lg my-3 mr-1 mb-1"
            >
              Enviar
            </button>
          </div>
  ...
  <!---------------------- separador -------------------------------------->
  <div
    class="md:flex py-2 bg-cyan-700 text-indigo-200 text-center font-bold mx-4"
  >
    <h2 class="max-w-lg mb-6 font-sans text-black-900 sm:text-4xl md:mx-auto">
      Ubicación
    </h2>
  </div>
  ...
  <section class="text-gray-600 body-font relative my-10 mx-10">
    <div class="absolute inset-0 bg-gray-300 mx-7">
      <iframe
        src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d1819.802963139568!2d-65.29844263368116!3d-24.185549499208697!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x941b0f42fb4efd45%3A0x28abb7f0e20ea8be!2sSarmiento%2C%20San%20Salvador%20de%20Jujuy%2C%20Jujuy!5e0!3m2!1sen!2sar!4v1682622990790!5m2!1sen!2sar"
        width="100%"
        height="100%"
        frameborder="0"
        marginheight="0"
    ...
    <div class="container px-5 py-24 flex">
      <div
        class="lg:w-1/3 md:w-1/2 bg-white rounded-lg p-8 flex flex-col md:ml-auto w-3 mt-10 md:mt-0 relative z-10 shadow-md"
      >
        ...
        <div class="relative mb-4">
          <label for="email" class="leading-7 text-sm text-gray-600"
            >Ingrese su ubicación actual</label
          >
          <input
            type="text"
